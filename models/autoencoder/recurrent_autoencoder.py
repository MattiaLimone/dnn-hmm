...
class RecurrentAutoEncoder(Sequential):
    ...
    def __init__(self, n_encoding_layers: int = _LAYER_NUM_DEFAULT, input_neurons: int = _DEFAULT_INPUT_DIM,
                 ...
                 unit_type: str = "LSTM", activation='relu', recurrent_activation: str = 'sigmoid', dropout: float = 0,
                 recurrent_dropout: float = 0, recurrent_initializer: str = 'glorot_uniform',
                 ...
                 kernel_constraint=None, bias_constraint=None, return_sequences: bool = True,
        ...
        :param encoding_dims: List of dimension of each layer of the encoder/decoder. Size must be the same as
        n_encoding_layers
        ...
        inputs. Default: 0
        :param recurrent_dropout: Float between 0 and 1. Fraction of the units to drop for the linear transformation
        ...
        :param kernel_initializer: Initializer for the kernel weights matrix, used for the linear transformation of the
        ...
        :param return_sequences: Boolean. Whether to return the last output. in the output sequence, or the
        ...
        reversed sequence
        :param stateful: Boolean (default False). If True, the last state for each sample at index i in a batch will be
        ...
        Using time_major = True is a bit more efficient because it avoids transposes at the beginning and end of the RNN
        calculation. However, most TensorFlow data is batch-major, so by default this function accepts input and emits

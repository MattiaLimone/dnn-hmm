...
from preprocessing.constants import AUDIO_DATAFRAME_KEY, TRAIN_SET_PATH_MFCCS, \
    TRAIN_SET_PATH_MEL_SPEC, AUDIO_PER_SPEAKER
from preprocessing.file_utils import generate_or_load_speaker_ordered_dict, \
    load_speakers_acoustic_models
...
def main():
    ...
    speaker_mixed_up_audio_labels = _generate_labels(speakers_mixed_up_audios_mfccs, acoustic_models)
